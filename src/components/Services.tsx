...
function ServiceRow({ service, reversed }: { service: Service; reversed: boolean }) {
  ...
  return (
    ...
    >
      <div className="aspect-[4/3] rounded-2xl border border-line bg-surface grid-texture flex items-center justify-center gradient-border">
        <div className="w-28 h-28 text-emerald">{service.icon}</div>
      </div>
      <div>
